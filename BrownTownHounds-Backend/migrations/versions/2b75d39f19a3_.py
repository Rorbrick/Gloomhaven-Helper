...
def upgrade():
    ...
    with op.batch_alter_table("cards", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_cards_char_class"), ["char_class"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_cards_image_path"), ["image_path"], unique=True
        )
    ...
    with op.batch_alter_table("party", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_party_location"), ["location"], unique=True
        )
        batch_op.create_index(batch_op.f("ix_party_name"), ["name"], unique=True)
        batch_op.create_index(
            batch_op.f("ix_party_reputation"), ["reputation"], unique=False
        )
    ...
    with op.batch_alter_table("character", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_character_class_id"), ["class_id"], unique=False
        )
        ...
        batch_op.create_index(
            batch_op.f("ix_character_perk_points"), ["perk_points"], unique=False
        )
    ...
    with op.batch_alter_table("class_perk", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_class_perk_times_unlockable"),
            ["times_unlockable"],
            unique=False,
        )
    ...
    with op.batch_alter_table("party_achievements", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_party_achievements_party_id"), ["party_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_party_achievements_timestamp"), ["timestamp"], unique=False
        )
    ...
    with op.batch_alter_table("party_notes", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_party_notes_party_id"), ["party_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_party_notes_timestamp"), ["timestamp"], unique=False
        )
    ...
    with op.batch_alter_table("retired_character", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_retired_character_class_id"), ["class_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_retired_character_gold"), ["gold"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_retired_character_level"), ["level"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_retired_character_name"), ["name"], unique=False
        )
    ...
    with op.batch_alter_table("character_perk", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_character_perk_times_unlocked"),
            ["times_unlocked"],
            unique=False,
        )
    ...
    with op.batch_alter_table("notes", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_notes_character_id"), ["character_id"], unique=False
        )
        batch_op.create_index(
