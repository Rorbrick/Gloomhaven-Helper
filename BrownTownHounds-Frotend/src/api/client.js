...
export const api = {
  ...
  createCharacterNote: (id, data) =>
    request(`/characters/${id}/notes`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  deleteCharacterNote: (id, note_id) =>
    request(`/characters/${id}/notes/${note_id}`, { method: "DELETE" }),
  listCharacterPerks: (id) => request(`/characters/${id}/perks`),
  updateCharacterPerk: (id, data) =>
    request(`/characters/${id}/perks`, {
      method: "PATCH",
      body: JSON.stringify(data),
    }),
  ...
  createParty: (data) =>
    request(`/parties`, { method: "POST", body: JSON.stringify(data) }),
  updateParty: (id, data) =>
    request(`/parties/${id}`, { method: "PATCH", body: JSON.stringify(data) }),
  deleteParty: (id) => request(`/parties/${id}`, { method: "DELETE" }),
  listPartyNotes: (id) => request(`/parties/${id}/notes`),
  createPartyNote: (id, data) =>
    request(`/parties/${id}/notes`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  deletePartyNote: (id, note_id) =>
    request(`/parties/${id}/notes/${note_id}`, { method: "DELETE" }),
  createPartyAchievement: (id, data) =>
    request(`/parties/${id}/achievements`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
